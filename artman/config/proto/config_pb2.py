...
_ARTIFACT_RELEASELEVEL = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='RELEAE_LEVEL_UNSPECIFIED', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_ARTIFACT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='service_yaml', full_name='googleapis.artman.Artifact.service_yaml', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gapic_yaml', full_name='googleapis.artman.Artifact.gapic_yaml', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='import_proto_path', full_name='googleapis.artman.Artifact.import_proto_path', index=9,
